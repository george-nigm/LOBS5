...
declare -A MODELS=(
  ...
  # S5-120M "best model" of the H1 scaling law (120,082,029 params counted from npz; leaderboard "S5-120m @135k"; d_model=1536, 12 layers, 500-msg ctx, 24tok);
  # same 64-dev-mesh ckpt problem as exp_H2 -> pre-converted npz (convert_s5_ckpt.py, job 5562660)
  [s5_120m]="S5_120M|s5_scenario.py|${CKPT_BASE}/exp_H1-scaling-law/checkpoints/j2514440_bkotgtm5_2514440|135458|503||/lus/lfs1aip2/projects/u6gb/lob_impact_grid/_ckpt_converted/s5_150m_j2514440_135458_params.npz"
