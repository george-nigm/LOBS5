#!/bin/bash
# MSFT panel fleet (in-distribution modal band, mb=261, NVDA-cost) -> lob_impact_grid_v2 (mirror of the GOOG panel, 2026-07-09).
...
mkdir -p "$HERE/logs"
JIDS="$HERE/logs/msft_fleet_jids_$(date +%Y%m%d-%H%M%S).txt"
