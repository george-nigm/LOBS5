...
DAILY=/home/u6gb/georgenigm.u6gb/LOBS5/lob_impact/2_daily_stats/results/daily_20260708-131449/daily_h_l_all.csv
...
$PY mid_trajectory.py --grid "$GRID" --stock "$STOCK" --shape "$SHAPE" --models "$MODELS" \
   ...
   --out "$B/results/mid_impact/mid_trajectory_${STOCK}_${TAG}_S5only.png"
