...
def _aggr_by_day(side_dir):
    """day -> insertion indices from PER-DAY aggressive_indices_<day>.csv (NOT the summary
    aggressive_indices.csv, which is just the last day — mb varies per day so using it for all
    days mis-aligns the insertion rows)."""
    out = {}
